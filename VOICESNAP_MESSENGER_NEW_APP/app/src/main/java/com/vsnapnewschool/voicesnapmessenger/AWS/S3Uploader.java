...
public class S3Uploader {
    ...
    public void initUpload(String filePath,String contenttype,String fileNameDateTime) {
        ...
        Log.d("AWScontenttype",contenttype);

        TransferObserver observer = transferUtility.upload(AWSKeys.BUCKET_NAME, fileNameDateTime+"_"+mediaUrl, file, CannedAccessControlList.PublicRead);
