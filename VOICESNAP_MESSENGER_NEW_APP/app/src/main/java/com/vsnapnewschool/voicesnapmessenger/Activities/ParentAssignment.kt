...
import com.vsnapnewschool.voicesnapmessenger.Adapters.ParentAssignmentTabAdapter
...
class ParentAssignment : BaseActivity(),View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sliding_tabs!!.addTab(sliding_tabs!!.newTab().setText(R.string.tab_due))
        sliding_tabs!!.addTab(sliding_tabs!!.newTab().setText(R.string.tab_completed))
        sliding_tabs!!.tabGravity = TabLayout.GRAVITY_FILL
        val adapter = ParentAssignmentTabAdapter(this, supportFragmentManager, sliding_tabs!!.tabCount)
