...
class AllStaffsAdapter(private val mContext: Context, private val staffslistener: checkAllStaffsListener?, private var staffsList: List<AllStaffsData>, private var isSelectAll: Boolean) : RecyclerView.Adapter<AllStaffsAdapter.MyViewHolder>() {
