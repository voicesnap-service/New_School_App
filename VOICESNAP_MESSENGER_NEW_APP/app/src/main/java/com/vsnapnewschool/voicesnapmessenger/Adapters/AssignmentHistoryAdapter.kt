...
class AssignmentHistoryAdapter(
    private var imagelist: ArrayList<GetAssingmentResponse.AssingmentData>,
    private val context: Context?,val AssignmentHistoryListener: AssingmentHistoryListener) : RecyclerView.Adapter<AssignmentHistoryAdapter.MyViewHolder>() {

    companion object {
        var historyListener: AssingmentHistoryListener? = null
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.run {
            historyListener = AssignmentHistoryListener
            historyListener?.onAssingmentHistoryClick(holder, text_info)
