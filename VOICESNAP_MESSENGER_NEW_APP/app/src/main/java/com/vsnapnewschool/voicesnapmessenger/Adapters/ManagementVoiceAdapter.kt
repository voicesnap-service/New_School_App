...
class ManagementVoiceAdapter (private var listname: ArrayList<MessageFromManagementVoiceResponse.VoiceData>, private val context: Context, val voiceClickListener: managementVoiceListener) : RecyclerView.Adapter<ManagementVoiceAdapter.MyViewHolder>() {
    companion object {
        var clickListener: managementVoiceListener? = null
    }

    fun update(updateTextList: ArrayList<MessageFromManagementVoiceResponse.VoiceData>) {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        clickListener = voiceClickListener
        clickListener?.onManagementVoiceClick(holder,voice_info)
