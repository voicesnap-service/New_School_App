...
class ParentImageListAdapter (private val listname: ArrayList<GetImageFilesResponse.GetImageData>, private val context: Context?, val imagelistListener: parentImageListListener) : RecyclerView.Adapter<ParentImageListAdapter.MyViewHolder>() {
    companion object {
        var imageclickListener: parentImageListListener? = null
    }
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var ImageFrame: FrameLayout
        init {
            ...
            ImageFrame = view.findViewById<View>(R.id.ImageFrame) as FrameLayout
        }
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.run {
            ...
            imageclickListener?.onImageListClick(holder,text_info)
