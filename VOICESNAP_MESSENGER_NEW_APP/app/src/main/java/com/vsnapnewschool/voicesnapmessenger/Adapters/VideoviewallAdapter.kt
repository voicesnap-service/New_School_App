...
class VideoviewallAdapter(private val videolist: ArrayList<ParentVideoDetail>, private val context: Context?, val videoViewListener: videoViewListener) : RecyclerView.Adapter<VideoviewallAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        videoClickListener?.videoViewClick(holder,videolist)
