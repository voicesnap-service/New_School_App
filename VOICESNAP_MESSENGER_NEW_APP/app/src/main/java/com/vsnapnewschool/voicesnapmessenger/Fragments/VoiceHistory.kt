...
class VoiceHistory : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        SchoolAPIServices.getVoiceHistoryListApi(context as Activity?)
        adds_layout.visibility=View.GONE

        voiceadapter = VoiceHistoryAdapter(voiceHistoryList, (context as Activity?)!!, object : voiceHistoryListener {
            override fun voiceHistoryClick(holder: VoiceHistoryAdapter.MyViewHolder,item: VoiceHistoryData) {
