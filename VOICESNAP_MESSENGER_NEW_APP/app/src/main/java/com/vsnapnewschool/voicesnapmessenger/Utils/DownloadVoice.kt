...
object DownloadVoice {
    ...
    fun downloadSampleFile(activity: Context?, urldata: String, folder: String?, fileName: String,refreshlistener: Refreshlistener) {
...
//                            TODO("Not yet implemented")
                    ...
                    AlertDownload(activity, "Exists", "This Voice is Already exists in your Folder: $folder/$fileName",refreshlistener)
    ...
    fun AlertDownload(activity: Context?, title: String?, msg: String?,refreshlistener: Refreshlistener) {
        val alertDialog = AlertDialog.Builder(activity)
        alertDialog.setCancelable(false)
        alertDialog.setTitle(title)
        alertDialog.setMessage(msg)
        alertDialog.setPositiveButton(R.string.teacher_btn_ok, DialogInterface.OnClickListener { dialog,
                                                                                                 which ->
            dialog.cancel()
