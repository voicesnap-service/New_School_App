...
import com.vsnapnewschool.voicesnapmessenger.Activities.TeacherCirculars;
import com.vsnapnewschool.voicesnapmessenger.Activities.TeacherEvents;
import com.vsnapnewschool.voicesnapmessenger.Activities.TeacherHomeWork;
...
//        activity.enableSearch(false);
    ...
    private void sendIntent() {
        ...
        if(screen.equals("Images")) {
            Intent intent = new Intent(ImageSelectActivity.this, BaseActivity.class);
            intent.putStringArrayListExtra("images", getSelected());
            setResult(RESULT_OK, intent);
            finish();
        } else if(Events.equals("Events")){
            Intent intent = new Intent(ImageSelectActivity.this, TeacherEvents.class);
            intent.putStringArrayListExtra("images", getSelected());
            setResult(RESULT_OK, intent);
            finish();
        } else if(Homework.equals("Homework")){
            Intent intent = new Intent(ImageSelectActivity.this, TeacherHomeWork.class);
            intent.putStringArrayListExtra("images", getSelected());
            setResult(RESULT_OK, intent);
            finish();
        }
        else if(screen.equals("Assignment")){
            Intent intent = new Intent(ImageSelectActivity.this, Assignment_PublishFragment.class);
            intent.putStringArrayListExtra("images", getSelected());
            setResult(RESULT_OK, intent);
            finish();
        }
        else if(screen.equals("Circulars")){
            Intent intent = new Intent(ImageSelectActivity.this, TeacherCirculars.class);
            intent.putStringArrayListExtra("images", getSelected());
            setResult(RESULT_OK, intent);
            finish();
        }
